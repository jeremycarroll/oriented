 ...
 * 
 */
public class SetOfSignedSetImpl extends SetImpl
< SignedSetInternal,
...
public SetOfSignedSetFactory factory() {
	...
	private UnsignedSetInternal computeSupport() {
		...
		UnsignedSetInternal r = 
			factory().setOfUnsignedSetFactory().itemFactory().empty();
...
//	}
	...
	public SetOfUnsignedSetInternal unsignedSets() {
		...
		return 
		   setOfUnsignedSetFactory.fromBackingCollection(s);
	}
	...
	public SetOfSignedSetInternal restriction(UnsignedSet x0) {
		JavaSet<SignedSetInternal> tx = factory().itemFactory().emptyCollectionOf();
