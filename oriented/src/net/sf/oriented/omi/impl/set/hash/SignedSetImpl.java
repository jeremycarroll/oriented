...
public class SignedSetImpl 
  extends HasFactoryImpl<SignedSetInternal,SignedSet,SignedSetInternal,SignedSetFactory> 
...
//	}
	...
	public SignedSetImpl compose(SignedSet b) {
		return new SignedSetImpl(plus.union(b.plus().minus(minus)), minus
				.union(b.minus().minus(plus)), factory());
	}
