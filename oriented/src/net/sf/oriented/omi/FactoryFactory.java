...
/**
 * This class generates {@link Factory}'s and {@link SetFactory}'s
 * for the interfaces in the API.
 * Depending on the {@link Options} passed to the constructor,
 * the String representations used by all the factories generated
 * will vary. It is, in general, not possible to pass
 * a String representation output by one group of factories,
 * arising from a particular {@link FactoryFactory}
 * to another group of factories, arising from a different
 *  {@link FactoryFactory}.
 *  It is however possible to pass an item constructed from
 *  String's between groups of factories.
 * @author jeremy
 *
 */
final public class FactoryFactory {
	...
	private void init() {
		...
		symmetricSetsOfSignedSet  = new SetOfSignedSetFactory(setsOfSignedSet, true);
	 ...
	 * The String representation may omit opposites.
