...
//	}
	...
	public void testSubsetsOfSize() {
		assertEquals("1 empty",1,unsigned("{a,b,c,d}").subsetsOfSize(0).size());
		assertEquals("1 elements",1,unsigned("{a}").subsetsOfSize(1).size());
		assertEquals("4 elements",4,unsigned("{a,b,c,d}").subsetsOfSize(1).size());
		assertEquals("6 pairs",6,unsigned("{a,b,c,d}").subsetsOfSize(2).size());
		assertEquals("4 triples",4,unsigned("{a,b,c,d}").subsetsOfSize(3).size());
