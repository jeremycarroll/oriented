...
public class TestExamples {
    ...
    public void testRingelAt7() {
        EuclideanPseudoLines realization = new EuclideanPseudoLines(Examples.ringel(),"7");
...
//            System.err.println("Label: "+lbl.label());
        EuclideanPseudoLines realization = new EuclideanPseudoLines(om,"1","4","6","5","8","7");
...
//        new DualFaceLattice(suvorov14);
    ...
    @Ignore // This one is very hard - needs maybe 4G, and 25 minutes at the moment
    @Test
...
//        for (Label lbl : g) {
//            System.err.println("Label: "+lbl.label());
        EuclideanPseudoLines realization = new EuclideanPseudoLines(om,"1");
        String[] crossings = realization.toCrossingsString();
        for (String str:crossings) {
            System.out.println(str);
        }
