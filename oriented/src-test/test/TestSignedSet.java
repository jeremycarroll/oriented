...
public class TestSignedSet {
	...
	public void testHashCode() {
		assertEquals(parse("ab'cd'e'f").hashCode(),
				parse("b'cd'e'fa").hashCode());
	}
	...
	public void testOpposite() {
		assertEquals(parse("abc'").opposite(),
				parse("a'b'c"));
	}

	@Test
	public void testPlus() {
		assertEquals(parse("abc'").plus(),
				unsigned("ab"));
	}

	@Test
	public void testMinus() {
		assertEquals(parse("abc'").minus(),
				unsigned("c"));
	}

	@Test
	public void testEqualsObject() {
		assertEquals(parse("ab'cd'e'f"),
				parse("b'cd'e'fa"));
	}

	@Test
	public void testEqualsIgnoreSign() {
		assertTrue(parse("ab'cd'e'f").equalsIgnoreSign(
				parse("b'cd'e'fa")));
		assertTrue(parse("ab'cd'e'f").equalsIgnoreSign(
				parse("bc'def'a'")));
	}
	...
	public void testSeparation() {
		assertEquals(parse("ab'de")
				.separation(parse("bcdf'")),
				unsigned("b"));
	}
	...
	public void testSize() {
		assertEquals(parse("ab'cd'e'f").size(),
				6);
	}
	...
	public void testSupport() {
		assertEquals(parse("ab'cd'e'f").support(),
				unsigned("abcdef"));
	}
