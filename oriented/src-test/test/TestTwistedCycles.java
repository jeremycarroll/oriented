...
import net.sf.oriented.pseudoline2.TGEdge;
import net.sf.oriented.pseudoline2.TGFactory;
import net.sf.oriented.pseudoline2.TGPath;
import net.sf.oriented.pseudoline2.TGPaths;
...
public class TestTwistedCycles {
